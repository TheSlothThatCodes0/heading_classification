...
MODEL_SAVE_PATH = "/home/pi0/heading_classification/doclaynet_training/models/lgbm_model_medium.pkl"
ENCODER_SAVE_PATH = "/home/pi0/heading_classification/doclaynet_training/models/label_encoder_medium.pkl"

def train_model():
    print("🚀 Starting MEDIUM-WEIGHT model training process...")
    ...
    # --- UPDATED: Use the medium-weight feature set ---
    features = [
    ...
    print("\n--- MEDIUM-WEIGHT Model Classification Report ---")
    print(report)
    ...
    print("\n✅ All done! Medium-weight model and encoder are saved.")
